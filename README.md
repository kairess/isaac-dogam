...
- 묶음 안은 **그 색이 짙은 것부터** 늘어놓습니다. 앞쪽이 온통 그 색인 아이콘,
  뒤로 갈수록 옅어지고, 맨 끝은 가장 검은 아이콘입니다
...
- 제목 옆에 지금 기기가 물고 있는 **판 번호**(`v15`)가 보입니다. **제목을 누르면 새로고침**
...
5. 끝으로 **넓이 × 진하기**를 비중으로 적어 둡니다. 화면에서는 묶음마다 이 값이 큰 것부터
   늘어놓아, 앞쪽에 온통 그 색인 아이콘이 오고 뒤로 갈수록 색이 옅어집니다.
   무채색 묶음은 밝기 순이라 맨 마지막이 가장 검은 아이콘입니다.
